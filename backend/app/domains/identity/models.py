...
from sqlalchemy import Boolean, String, Integer, DateTime, Enum as SQLAlchemyEnum, func
...
class UserRole(str, Enum):
    STUDENT = "STUDENT"
    EXPERT = "EXPERT"
    MENTOR = "MENTOR"   # Cố vấn: Tu vấn tùy hỷ (PWYW), không thu phí cố định
    ADMIN = "ADMIN"
...
class User(Base):
    ...
    # UPDATE (ARCH-11): Add created_at for proper admin sorting and audit trail.
