    ...
    if (isSubmitted) {
        return (
            <div className="animate-fade-in text-center">
                ...
                <h2 className="font-garamond italic font-light text-[32px] text-[#0A1018] mb-6">Kiểm tra Terminal!</h2>
    ...
    return (
        <div className="animate-fade-in">
            <div className="mb-12">
                ...
                <h1 className="font-garamond italic font-light text-[42px] leading-tight text-[#0A1018] mb-4">Quên <br /> mật khẩu?</h1>
                <p className="font-dm-sans text-[#0A1018]/60 text-xs font-light tracking-wide uppercase">Nhập email của bạn để nhận hướng dẫn khôi phục.</p>
            </div>
            ...
            <div className="mt-12 pt-8 border-t border-[#0A1018]/5 text-center font-dm-sans">
